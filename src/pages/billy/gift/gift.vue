  ...
  <div class="gird-box">
    <vxe-grid id="rechargerGridTable" ref="userGridRef" @checkbox-change="handleCheckboxChange"
      ...
      <template #toolbar_buttons>
        <vxe-input v-model="searchCode" class="my-search code" placeholder="搜索红包">
        </vxe-input>
...
export default {
    ...
    return {
      ...
      gridOptions: {
        ...
        columns: [
          ...
          { field: 'status', title: '是否领取', align: 'center', slots: { default: 'status' }, },
        ...
        proxyConfig: {
          ...
          ajax: {
            query: ({ page, sorts, filters, form }) => {
              ...
              if (this.searchCode) {
                queryParams.code_id = this.searchCode
              }
              ...
              return giftOrderList(queryParams)
  ...
  methods: {
    ...
    fetchUserData({ page, size, sort, filters }) {
      ...
      return giftOrderList(page, sort, filters);
    },
    editEvent(row) {
      this.selectRow = true
...
::v-deep .code .vxe-input--inner{
  padding-right: 0px !important;
  width: 100%;
}

.my-search:not(:first-child) {
  height: 32px;
  width: 220px;
  margin-left: 10px;
}
