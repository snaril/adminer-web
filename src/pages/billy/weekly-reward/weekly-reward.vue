  ...
  <div class="gird-box">
    <vxe-grid id="rechargerGridTable" ref="userGridRef" @checkbox-change="handleCheckboxChange"
      ...
      <template #toolbar_buttons>
        <vxe-input v-model="searchName" class="my-search" placeholder="搜索红包">
          <template #prefix>
            <div class="icon-box">
...
export default {
    ...
    return {
      ...
      gridOptions: {
        ...
        columns: [
          ...
          { field: 'phone', title: '账号', width: 100, align: 'center' },
        ...
        proxyConfig: {
          ...
          ajax: {
            query: ({ page, sorts, filters, form }) => {
              ...
              return weeklyOrderList(queryParams)
  ...
  methods: {
    ...
    fetchUserData({ page, size, sort, filters }) {
      ...
      return weeklyOrderList(page, sort, filters);
    },
    editEvent(row) {
      this.selectRow = true
