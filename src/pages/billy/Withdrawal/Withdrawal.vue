    ...
    <vxe-grid id="rechargerGridTable" ref="userGridRef" @checkbox-change="handleCheckboxChange"
      ...
      <template v-slot:status="{ row }">
        <div style="width: 100%; height: 100%" class="flex justify-center items-center">
          ...
          <el-tag v-else-if="row.status > 2" type="danger" style="width: 56px;">反转</el-tag>
          <el-tag v-else type="info" style="width: 56px;">审核中</el-tag>
          <span></span>
        </div>
      ...
      <template v-slot:Amount="{ row }">
        <div style="width: 100%; height: 100%" class="flex justify-center items-center">
          ...
          <el-tag v-else type="success" style="width: 56px;">{{ row.arrived_amount }}</el-tag>
...
export default {
        ...
        proxyConfig: {
          ...
          ajax: {
            query: ({ page, sorts, filters, form }) => {
              ...
              return withdrawOrderList(queryParams)
  ...
  methods: {
    ...
    fetchUserData({ page, size, sort, filters }) {
      ...
      return withdrawOrderList(page, sort, filters);
    },
    editEvent(row) {
      this.selectRow = true
